...
class CanvasDnD(tk.Frame):
    def __init__(self, master):
        ...
        self.default_color = canvas.itemcget(canvas.create_text(30, 25, font=("Helvetica", 14), text="Item 1", tags="DnD"), "fill")
    ...
    def chkup(self, event):
        ...
        event.widget.itemconfigure(tk.CURRENT, fill=self.default_color)
    ...
    def up(self, event):
        event.widget.unbind("<Motion>")
        if not self.target == event.widget.find_withtag(tk.CURRENT):
